(function () {
                ...
                for (e = arguments[0], o = 0, i = (r = 2 <= arguments.length ? K.call(arguments, 1) : []).length; i > o; o++)
                    if ((n = r[o]))
                        for (t in n)
                            Q.call(n, t) &&
                                ((s = n[t]),
                                null != e[t] && 'object' == typeof e[t] && null != s && 'object' == typeof s
                                    ? k(e[t], s)
                                    : (e[t] = s));
                return e;
            },
    ...
    (u = (function (t) {
                ...
                if (null != W && E.ajax.trackWebSockets) {
                    window.WebSocket = function (t, e) {
                        ...
                        return (
                            ...
                            _('socket') && n.trigger('request', { type: 'socket', url: t, protocols: e, request: r }),
                            r
                        );
                    };
                    try {
            ...
            return (
                (t.prototype.watch = function (t) {
                    ...
                    return (
                        ...
                        (e = t.request),
                        (s = t.url),
                        O(s) ? void 0 : ((n = 'socket' === r ? new f(e) : new d(e)), this.elements.push(n))
                    );
                }),
                t
            );
        ...
        (f = (function () {
            return function (t) {
                var e,
                    ...
                    s,
                    o = this;
                for (this.progress = 0, n = 0, r = (s = ['error', 'open']).length; r > n; n++)
                    (e = s[n]),
                        t.addEventListener(
                            e,
                            function () {
        ...
        (R = function () {
            var t, n, r, s, o, i, a, u;
            for (c.sources = C = [], n = 0, s = (i = ['ajax', 'elements', 'document', 'eventLag']).length; s > n; n++)
                ...
                (g = A(function (e, n) {
                    ...
                    for (100 - y.progress, s = d = 0, o = !0, u = g = 0, w = C.length; w > g; u = ++g)
                        for (
                            ...
                            (i = a[l]), (o &= (p = null != f[l] ? f[l] : (f[l] = new h(i))).done), p.done || (s++, (d += p.tick(e)));
                    return (
                        (r = d / s),
                        y.update(U.tick(e, r)),
                        y.done() || o || v
